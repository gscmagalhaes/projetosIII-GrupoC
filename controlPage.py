...
# Implementação do LED INDICADOR DE STATUS
...
def front():
    layout = [
        ...
        [
            sg.Frame(layout=[
                [
                    sg.Text('ÂNGULO DO GUINDASTE', size=(45, 1), justification='center'),
                    sg.Text('ALTURA DO GUINCHO', size=(45, 1), justification='center'),
                    sg.Text('EXTENSÃO DO BRAÇO', size=(45, 1), justification='center')
                ],
                [
                ...
                [
                    sg.Frame(layout=[[sg.Text(size=(17, 1), justification='center', font=("Helvetica", 25), key='-ANGULO-')]], title=''),
                    sg.Frame(layout=[[sg.Text(size=(17, 1), justification='center', font=("Helvetica", 25), key='-ALTURA-')]], title=''),
                    sg.Frame(layout=[[sg.Text(size=(17, 1), justification='center', font=("Helvetica", 25), key='-EXTENSAO-')]], title='')
                ]
            ], title='Posições')
        ],
        [
            sg.Frame(layout=[
                ...
                [
                    sg.Frame(layout =[
                        [
                            sg.Button('COLETAR', size=[15, 1]), sg.Frame(layout=[[LEDIndicator('_GET_')]], title=''), sg.Button('SOLTAR', size=[15, 1])
                        ]
                    ], title='')
                ],
                [sg.Text(' ')],
    ...
    while True:
        ...
        else: # button == 'Atualizar':
            # PROBLEMA: while não está atualizando a pagina automaticamente.
